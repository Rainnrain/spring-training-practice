...
public class LoggingAspect {
    ...
    Logger logger = LoggerFactory.getLogger(LoggingAspect.class); // gives a logger objecty
...
//    public void deforeControllerOrServiceAdvice(JoinPoint joinPoint){
//        logger.info("Before -> Method: {}, Arguments: {}, Target:{}",
//                joinPoint.getSignature(), joinPoint.getArgs(), joinPoint.getTarget());
//    }
...
//    public void afterReturningGetMappingOperation(JoinPoint joinPoint, List<CourseDTO> result){
