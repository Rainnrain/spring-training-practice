...
@WebMvcTest(StudentController.class)// Student controller bean
public class StudentControllerTest {

    @Autowired
    private MockMvc mvc; // mvc bean

    @MockBean
    StudentService studentService; // student service bean
    ...
    void jsonAssert_Test() throws Exception {
        ...
        JSONAssert.assertEquals(expected, actual, false); // This is not the preferred way
        // False means if you remove the age feild from expected it will still pass since what every was sent matched
        //You aren't matching the whole output
    }
